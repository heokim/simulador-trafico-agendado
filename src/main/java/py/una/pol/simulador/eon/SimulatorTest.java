...
public class SimulatorTest {
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        ERLANG = 1800;
        DESCRIPCION = "Dinamico, corregido IA, sin mejora de sortedKSP ni sortedCores, Paralelo findAny()";
        T_RANGE_MIN = 0;
        T_RANGE_MAX = 0;
        for (int i = 0; i < 10; i++) {
            simular();
...
//        ERLANG = 1800;
//        DESCRIPCION = "Agendado [5, 8], corregido IA, sin mejora de sortedKSP ni sortedCores, Paralelo findAny()";
//        T_RANGE_MIN = 5;
//        T_RANGE_MAX = 8;
//        simular();
//
