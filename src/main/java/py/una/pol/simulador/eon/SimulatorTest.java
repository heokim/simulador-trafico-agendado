...
//        }
        ...
        DESCRIPCION = "Test de trafico Dinamico, k caminos mas cortos ordenados por peso(FS ocupadas del core), y seleccion de core por fragmentacion";
        ERLANG = 4800;
        DESCRIPCION = "Test de trafico Agendado [1, 3], k ordenado por peso (FS ocupados de un core), y seleccion de core por fragmentacion";
        T_RANGE_MIN = 1;
        T_RANGE_MAX = 3;
        simular();

        DESCRIPCION = "Test de trafico Agendado [5, 8], k ordenado por peso (FS ocupados de un core), y seleccion de core por fragmentacion";
        T_RANGE_MIN = 5;
        T_RANGE_MAX = 8;
        simular();

        DESCRIPCION = "Test de trafico Agendado [10, 20], k ordenado por peso (FS ocupados de un core), y seleccion de core por fragmentacion";
        T_RANGE_MIN = 10;
        T_RANGE_MAX = 20;
